...
HD_PWD='D:/20SP/CA/lab/CPU_Cache/CPU_Cache.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_lru.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cache_lru.tcl
